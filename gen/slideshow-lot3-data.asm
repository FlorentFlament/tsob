...
slideshow_14_a_p0:
	...
	dc.b $70, $70, $70, $70, $f0, $f0, $f0, $f0
	dc.b $f0, $f0, $f0, $f0, $f0, $f0, $f0, $f0
	dc.b $f0, $f0, $f0, $f0, $f0, $f0, $00, $00
slideshow_14_a_p1:
	dc.b $00, $00, $fe, $f1, $e7, $dc, $db, $ba
	dc.b $b0, $b9, $5f, $60, $7f, $ff, $ff, $ff
	dc.b $ff, $ff, $ff, $ff, $7f, $7f, $7f, $bf
	dc.b $bf, $bf, $df, $ef, $ef, $f7, $fb, $fd
	dc.b $fe, $ff, $ff, $ff, $ff, $ff, $00, $00
slideshow_14_a_p2:
	dc.b $00, $00, $18, $e3, $fe, $ff, $ff, $ff
	dc.b $ff, $ff, $7d, $7e, $3e, $7e, $fe, $fe
	dc.b $fd, $3d, $5b, $d7, $37, $f7, $0e, $fd
	dc.b $03, $ff, $ff, $7f, $ff, $ff, $ff, $ff
	dc.b $ff, $fe, $fd, $f3, $cf, $3f, $00, $00
slideshow_14_a_p3:
	dc.b $00, $00, $00, $f0, $70, $b0, $d0, $d0
	dc.b $00, $00, $00, $e0, $f0, $f0, $f0, $f0
	dc.b $70, $e0, $40, $50, $e0, $f0, $00, $f0
	dc.b $e0, $f0, $10, $e0, $f0, $f0, $f0, $f0
	dc.b $f0, $f0, $f0, $f0, $f0, $00, $00, $00
slideshow_14_a_p4:
	dc.b $00, $00, $1f, $e7, $39, $de, $67, $73
	dc.b $c1, $01, $00, $f8, $fe, $cf, $b1, $fe
	dc.b $ff, $7f, $3f, $5f, $0f, $f7, $18, $e7
	dc.b $df, $df, $07, $f8, $ff, $ff, $ff, $ff
	dc.b $ff, $ff, $ff, $fc, $f3, $0f, $00, $00
slideshow_14_a_p5:
	dc.b $00, $00, $ff, $ff, $ff, $ff, $fe, $fd
	dc.b $fd, $fb, $fb, $f7, $f6, $f5, $f7, $f7
	dc.b $fa, $fd, $fd, $fd, $fd, $fe, $ff, $ff
	dc.b $ff, $ff, $ff, $fe, $fd, $fb, $f7, $f7
	dc.b $f7, $fb, $fc, $ff, $ff, $ff, $00, $00
slideshow_14_a_ptr:
